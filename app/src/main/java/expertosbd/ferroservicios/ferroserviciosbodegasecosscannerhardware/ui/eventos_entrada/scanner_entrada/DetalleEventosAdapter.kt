...
class DetalleEventosAdapter(val context: Context, private val items: MutableList<DetalleEvento>,
                            activity: Activity
) :
    ...
    interface OnItemClickListener {
        fun onItemClicked(item: DetalleEvento)
    }
