...
class EventosSalidaPresenter : EventosSalidaContract.Presenter {

    private val api: ApiServiceInterface = ApiServiceInterface.create()
    private val subscriptions = CompositeDisposable()
    private lateinit var view: EventosSalidaContract.View
    ...
    override fun attach(view: EventosSalidaContract.View) {
        this.view = view
    }
