...
class ScannerSalidaPendingAdapter(val context: Context,
                                  private var items: MutableList<DetalleEventoSalida> = mutableListOf(),
                                  activity: Activity
) :
    RecyclerView.Adapter<ScannerSalidaPendingAdapter.ScannerViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ScannerViewHolder {
        ...
        return ScannerSalidaPendingAdapter.ScannerViewHolder(itemView)
    }
